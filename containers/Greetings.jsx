		...
		<main>
			<div className="position-relative">
				<section className="section section-lg section-shaped pb-200">
					...
					<div className="py-lg-md d-flex col-12 px-5">
						<div className="col px-0">
							<Row>
								<Col lg="7" className="px-6">
									<div className="text-white" style={{marginTop: 80}}>
										<h1 className="ml2">Denish Suhagiya</h1>
									</div>
								...
								<Col style={{padding:0, margin: 0 -10}} >
									<GreetingLottie animationPath={basePrefix+"/lottie/coding.json"} />
								</Col>
							</Row>
						</div>
					</div>
